...
LDLIBSOPTIONS=-L/C/Program\ Files\ \(x86\)/Microsoft\ DirectX\ SDK\ \(June\ 2010\)/Lib/x86
...
${OBJECTDIR}/cDirectX.o: cDirectX.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/Program\ Files\ \(x86\)/Microsoft\ DirectX\ SDK\ \(June\ 2010\)/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cDirectX.o cDirectX.cpp

${OBJECTDIR}/cDrawings.o: cDrawings.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/Program\ Files\ \(x86\)/Microsoft\ DirectX\ SDK\ \(June\ 2010\)/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cDrawings.o cDrawings.cpp

${OBJECTDIR}/cMain.o: cMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/C/Program\ Files\ \(x86\)/Microsoft\ DirectX\ SDK\ \(June\ 2010\)/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cMain.o cMain.cpp
