package org.d2predict.dotaheroprediction.javacvSamples;
...
public class BlobDemo {
    ...
    public static void demo() {
        ...
        String path = BlobDemo.class.getProtectionDomain().getCodeSource().getLocation().getPath();

        // Read an image.
        for (int k = 0; k < 7; k++) {
            if (k == 0) {
                RawImage = cvLoadImage("target/javacvSamples/BlackBalls.jpg");
                MinArea = 250;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 1) {
                RawImage = cvLoadImage("target/javacvSamples/Shapes1.jpg");
                MinArea = 6;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 2) {
                RawImage = cvLoadImage("target/javacvSamples/Shapes2.jpg");
                MinArea = 250;
                ErodeCount = 0;
                DilateCount = 1;
            } else if (k == 3) {
                RawImage = cvLoadImage("target/javacvSamples/Blob1.jpg");
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 4) {
                RawImage = cvLoadImage("target/javacvSamples/Blob2.jpg");
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 5) {
                RawImage = cvLoadImage("target/javacvSamples/Blob3.jpg");
                MinArea = 2800;
                ErodeCount = 1;
                DilateCount = 1;
            } else if (k == 6) {
                RawImage = cvLoadImage("target/javacvSamples/Rice.jpg");
                MinArea = 30;
                ErodeCount = 2;
                DilateCount = 1;
            }
